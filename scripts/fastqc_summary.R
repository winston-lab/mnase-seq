...
main = function(seq_len_dist_in, per_tile_in, per_base_qual_in,
    ...
    ggsave(per_tile_out, plot=tile_quality_plot, width=14, height=2+2*nsamples, units="cm", limitsize=FALSE)
    ...
    ggsave(adapter_content_out, plot=adapter_plot, width=26, height=2+1.25*nsamples, units="cm", limitsize=FALSE)
    ...
    ggsave(per_base_seq_out, plot=per_base_seq_plot, width=26, height=2+2.25*nsamples, units="cm", limitsize=FALSE)
